...
const styles = StyleSheet.create({
  ...
  dateBox: { flexDirection: 'row', gap: 12, alignItems: 'flex-end', marginBottom: 20, flexWrap: 'wrap' },
  label: { fontSize: 10, fontWeight: '900', color: colors.mutedDark, letterSpacing: 1, marginBottom: 8, textTransform: 'uppercase' },
  dateInputWrap: {
    flexDirection: 'row', alignItems: 'center', gap: 10, borderWidth: 1, borderColor: colors.border,
    borderRadius: 12, paddingHorizontal: 16, height: 44, backgroundColor: '#FFFFFF', ...shadows.xs,
  },
  dateInput: { flex: 1, color: colors.onSurface, fontSize: 14, fontWeight: '600' },
  applyBtn: {
    backgroundColor: colors.brandPrimary, paddingHorizontal: 20, height: 44,
    flexDirection: 'row', alignItems: 'center', gap: 8, borderRadius: 12, ...shadows.sm,
  },
  applyBtnText: { color: '#FFFFFF', fontWeight: '800', fontSize: 12, letterSpacing: 0.5 },

  presetRow: { flexDirection: 'row', gap: 10, marginBottom: 24, flexWrap: 'wrap' },
  presetChip: {
    borderWidth: 1, borderColor: colors.border, backgroundColor: '#FFFFFF',
    paddingHorizontal: 16, paddingVertical: 10, borderRadius: 12, flexDirection: 'row', alignItems: 'center', ...shadows.xs,
  },
  presetText: { fontWeight: '700', color: colors.onSurface, fontSize: 13 },
  exportBtn: {
  ...
  kpiCard: {
    flexGrow: 1, flexBasis: '22%', minWidth: 200, backgroundColor: '#FFFFFF',
    borderWidth: 1, borderColor: colors.border, borderRadius: 16, padding: 24, ...shadows.sm,
  },
  kpiIconWrap: { width: 44, height: 44, borderRadius: 12, alignItems: 'center', justifyContent: 'center', marginBottom: 16 },
  kpiValue: { fontSize: 28, fontWeight: '900', color: colors.onSurface },
  kpiLabel: { fontSize: 10, fontWeight: '800', color: colors.muted, letterSpacing: 1, marginTop: 4, textTransform: 'uppercase' },

  section: { marginBottom: 32 },
  sectionTitle: {
    fontSize: 12, fontWeight: '900', color: colors.brandPrimary, letterSpacing: 2,
    marginBottom: 16, textTransform: 'uppercase',
  },
  sectionBody: {
    backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: colors.border,
    borderRadius: 20, padding: 24, ...shadows.md,
  },
  distRow: { paddingVertical: 12, gap: 10, borderBottomWidth: 1, borderBottomColor: colors.divider },
  distLabel: { fontSize: 14, fontWeight: '700', color: colors.onSurface },
  barWrap: { flex: 1, height: 28, backgroundColor: colors.surfaceTertiary, position: 'relative', justifyContent: 'center', borderRadius: 8, overflow: 'hidden' },
  bar: { position: 'absolute', left: 0, top: 0, bottom: 0 },
  barValue: { position: 'absolute', right: 12, color: colors.onSurface, fontWeight: '800', fontSize: 12 },
  inspectorRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 14, gap: 16, borderBottomWidth: 1, borderBottomColor: colors.divider },
  inspectorName: { color: colors.onSurface, fontWeight: '800', fontSize: 14 },
  inspectorMeta: { color: colors.muted, fontSize: 11, fontWeight: '600', marginTop: 2 },
  failRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, gap: 16, borderBottomWidth: 1, borderBottomColor: colors.divider },
  failLabel: { color: colors.onSurface, fontWeight: '700', fontSize: 12, flex: 1.5 },
  emptyText: { color: colors.muted, fontStyle: 'italic', fontSize: 14, paddingVertical: 12, textAlign: 'center' },
});
