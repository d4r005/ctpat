...
const styles = StyleSheet.create({
  ...
  sectionBody: { backgroundColor: colors.surfaceSecondary, borderWidth: 1, borderColor: colors.borderStrong, borderTopWidth: 0 },
  ...
  pointPhoto: { width: '100%', height: 180, marginTop: 8, borderWidth: 1, borderColor: colors.error, resizeMode: 'cover' },
  ...
  firmaImagePlaceholder: { borderWidth: 1, borderColor: colors.success, padding: spacing.md, alignItems: 'center' },
  ...
  approvalInfo: { borderWidth: 1, borderColor: colors.borderStrong, padding: spacing.md, backgroundColor: colors.surfaceSecondary, marginBottom: spacing.lg },
  ...
  approvalActionBox: { borderWidth: 1, borderColor: colors.brandPrimary, padding: spacing.md, backgroundColor: colors.brandTertiary, marginBottom: spacing.lg },
  sectionTitleLocal: { fontWeight: '900', color: colors.onBrandTertiary, letterSpacing: 1, marginBottom: spacing.sm },
  noteInput: {
    borderWidth: 1, borderColor: colors.borderStrong, padding: spacing.sm, backgroundColor: colors.surfaceSecondary,
  ...
  signatureBox: {
    borderWidth: 1, borderColor: colors.borderStrong, padding: spacing.lg,
