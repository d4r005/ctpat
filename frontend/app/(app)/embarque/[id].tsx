...
const styles = StyleSheet.create({
  ...
  section: { backgroundColor: '#FFF', borderWidth: 1, borderColor: colors.borderStrong },
  ...
  sigModalContent: { backgroundColor: '#FFF', width: '100%', maxWidth: 500, borderRadius: 8, padding: spacing.md, borderWidth: 1, borderColor: colors.borderStrong },
