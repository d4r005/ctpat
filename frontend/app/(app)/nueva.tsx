...
const styles = StyleSheet.create({
  ...
  searchBox: { flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.borderStrong, paddingHorizontal: spacing.sm, height: 48 },
  ...
  row: { backgroundColor: colors.surfaceSecondary, borderWidth: 1, borderColor: colors.borderStrong, padding: spacing.md, marginBottom: spacing.sm, flexDirection: 'row', alignItems: 'center' },
  ...
  input: { borderWidth: 1, borderColor: colors.borderStrong, padding: 10, marginBottom: 15, backgroundColor: '#FFF', fontSize: 16 },
  ...
  checkbox: { width: 24, height: 24, borderWidth: 1, borderColor: colors.borderStrong, alignItems: 'center', justifyContent: 'center' },
  ...
  failCard: { padding: 15, backgroundColor: '#FFF', borderWidth: 1, borderColor: colors.error, marginBottom: 15 },
  ...
  sigArea: { height: 120, borderWidth: 1, borderColor: colors.borderStrong, backgroundColor: '#FFF', alignItems: 'center', justifyContent: 'center', marginTop: 5 },
  ...
  wizBtnSec: { flex: 1, backgroundColor: '#FFF', borderWidth: 1, borderColor: colors.borderStrong, padding: 15, alignItems: 'center', justifyContent: 'center' },
  ...
  modalCard: { backgroundColor: '#FFF', padding: 20, borderWidth: 1, borderColor: colors.borderStrong },
  modalTitle: { fontWeight: '900', marginBottom: 15 },
  sigCanvasCont: { height: 300, borderWidth: 1, borderColor: '#EEE', marginBottom: 20 },
  modalActions: { flexDirection: 'row', gap: 10 },
  boxChip: { paddingHorizontal: 15, paddingVertical: 10, borderWidth: 1, borderColor: colors.borderStrong, backgroundColor: '#FFF', marginRight: 10 },
  ...
  measureInput: { borderWidth: 1, borderColor: colors.borderStrong, padding: 8, backgroundColor: '#FFF', fontSize: 14, fontWeight: '700' },
